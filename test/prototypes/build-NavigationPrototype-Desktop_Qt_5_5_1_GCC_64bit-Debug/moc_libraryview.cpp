...
#include "../NavigationPrototype/libraryview.h"
...
void LibraryView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->libraryChosen((*reinterpret_cast< QString(*)>(_a[1]))); break;
        ...
        {
            typedef void (LibraryView::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&LibraryView::libraryChosen)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject LibraryView::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_LibraryView.data,
      qt_meta_data_LibraryView,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
// SIGNAL 0
void LibraryView::libraryChosen(QString _t1)
{
