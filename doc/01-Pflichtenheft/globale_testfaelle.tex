...
\begin{enumerate} [label=\bfseries /TSW \arabic*0/, leftmargin=*]
	...
	\begin{enumerate}[leftmargin=0pt]
		\item
		\begin{description}
			\item[Vorbedingung] Das Programm zeigt die Übersicht eines Bilddatensatzes; ein Bild ist ausgewählt (\ref{fw:zoom_scroll})
			\item[Aktion] Der Benutzer rollt das Mausrad vorwärts während sich der Cursor über der größeren Ansicht befindet
