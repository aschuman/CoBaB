...
\begin{enumerate} [label=\bfseries /TS \arabic*0/, leftmargin=*]
	...
	\begin{enumerate}[leftmargin=0pt]
		...
		\end{description}
	\end{enumerate}
	Es bleibt zu testen, dass sich die Ergebnisse der zweiten im Sinne des \glslink{Feedback}{Feedbacks} verändert haben (oder gleich bleiben), wofür kein Testfall formuliert wird.
