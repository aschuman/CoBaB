...
\begin{description} %[label=\bfseries /TS \arabic*0/]
	...
	\begin{enumerate}
		...
		\item
		\begin{description}
			\item[Aktion] Der Benutzer verwendet das Mausrad zum Zoomen und Drag-and-Drop zum Scrollen in der vergrößerten Ansicht (\req{F 130})
			\item[Nachbedingung] Die vergröerte Ansicht zoomt und scrollt
		\end{description}
		\item
		\begin{description}
			\item[Aktion] Der Benutzer rechtsklickt auf einen annotierten Bildbereich (\req{F 160})
			\item[Nachbedingung] Es wird ein Kontextmenü angezeigt in dem mindestens ein Suchverfahren zur Auswahl bereitsteht (\req{F 30})
		\end{description}
		\item
		\begin{description}
		...
		\item
		\begin{description}
			\item[Aktion] Der Benutzer verwendet das Mausrad zum Zoomen und Drag-and-Drop zum Scrollen in der vergrößerten Ansicht (\req{FW 70}) % Achtung! Wunschanforderung.
			\item[Nachbedingung] Die vergröerte Ansicht zoomt und scrollt
		\end{description}
	\end{enumerate}
