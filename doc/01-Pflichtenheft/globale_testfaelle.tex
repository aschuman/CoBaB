...
\begin{enumerate} [label=\bfseries /TF \arabic*0/]
	\item
	\begin{enumerate}
		\item Datensatz zur Bibliothek hinzufügen % Vorgang zu generisch beschrieben; ToDo: bestimmte Datensätze und Verfahren zur konkretisierung spezifizieren und hier verwenden
		\begin{description}
