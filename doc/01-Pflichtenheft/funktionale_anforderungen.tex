...
%	\item[\req{F 0}] Er\"offnen eines neuen \glslink{Suchkontext}{Suchkontexts}
	...
	\item[\req{F 180}] Anzeigen einer Beschreibung für die Suchverfahren
	\item[\req{F 190}] Festlegen der für das gewählte Suchverfahren spezifischen Parameter
	\item[\req{F 200}] Anzeigen der eingestellten Parameter zur Überprüfung durch den Benutzer
	\newline
	\item[\req{F 210}] Starten der Suche
	\item[\req{F 220}] Anzeigen einer Fortschrittsanimation während des Suchvorgangs
	\item[\req{F 230}] Abbrechen der Suche
	\newline
	\item[\req{F 240}] Anzeigen einer \"Ubersicht der Suchergebnisse
	\item[\req{F 250}] Anzeigen einer größeren Darstellung eines ausgewählten Suchergebnisses
	\item[\req{F 260}] Abspielen eines Videos aus Einzelbildern
	\item[\req{F 270}] Einstellen eines Feedbacks zu einem Suchergebnis
	\item[\req{F 280}] \"Ubermitteln des Feedbacks an das Suchverfahren
	\item[\req{F 290}] Speichern der Suchergebnisse (siehe auch \req{F 60})
	\newline
	\item[\req{F 300}] Unterstützung der Bildformate JPEG, PNG und BMP
	\item[\req{F 310}] Unterstützung von Videos in Form von Einzelbildern in untert\"utzten Bildformaten
\end{description}
