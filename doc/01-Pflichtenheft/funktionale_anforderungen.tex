...
%	\item[\req{F 0}] Er\"offnen eines neuen \glslink{Suchkontext}{Suchkontexts}
	\item[\req{F 60}] Wiederanzeigen der Ergebnisse einer gespeicherten vergangenen Suche (siehe auch \req{F 310})
	\item[\req{F 65}] Wiederanzeigen der Ergebnisse zuletzt beendeter Suchen (siehe auch \req{F 315})
	\item[\req{F 70}] Anzeigen einer Übersicht der gespeicherten Suchergebnisse
	\item[\req{F 75}] Anzeigen einer Übersicht der Ergebnisse zuletzt beendeter Suchen
	...
	\item[\req{F 315}] automatisches nicht-flüchtiges Speichern der letzten Suchergebnisse (siehe auch \req{F 65})
