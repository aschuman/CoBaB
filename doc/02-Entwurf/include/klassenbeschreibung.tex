...
Das ist das Widget, in dem alle Datensätze dargestellt werden und man wählen kann, in welchem von denen man ein Bild aussuchen will, nach dem danach gesucht wird. Durch das ChooseDataSetButton kann man auch einen Datensatz wählen, der nicht im Datenbank liegt. 
...
Erbt von CViewerPageWidget und seine Funktion ist das Darstellen der Bilder, die in einem Datensatz enthalten sind.
...
Das ist das Widget, wo die Ergebnisse der Suche erscheinen. Man kann die Suche speichern oder bewerten und erneut suchen.
